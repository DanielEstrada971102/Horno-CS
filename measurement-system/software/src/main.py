...
ui_filename = Path("../ui_files/interface.ui")
home_page_filename = Path("../resources/home-page.html")
...
class MS_interface(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        f = QtCore.QFile(str(home_page_filename))
        f.open(QtCore.QFile.ReadOnly)
        self.home_content.setHtml(QtCore.QTextStream(f).readAll())
        f.close()
        # upload parameters
    ...
    def upload_default_params(self):
        ...
        self.output_path = Path(self.default_params.get("out_path", "./results"))
